  ...
  return (
    ...
    <main className= "bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
      <section className="min-h-screen">
        ...
        <div className="relative mx-auto bg-gradient-to-b from-teal-500 rounded-full  h-40 w-40  mt-20 overflow-hidden sm:w-80 sm:h-80 md:h-96 md:w-96">
